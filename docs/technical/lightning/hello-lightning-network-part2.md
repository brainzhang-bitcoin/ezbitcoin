...
为了研究如何解决Inbound Capacity的问题，我们还需要复习并深化闪电网络的一些基础知识；即RSMC 和HTLC；这些基础我们曾在[之前的文章中](hello-lightning-network-part0.md)简要介绍过，但只是对网上的资料做了一番整理，人云亦云而已，实在是辜负了闪电网络；
...
![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_bg0-1.jpg)
...
![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_bg0-2.jpg)
...
![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_bg1-0.jpg)
...
![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_htlc2-1.jpg)

这个图跟我们在更新Commitment Tx的时候没有多大区别，最大的不同就是我们多了一个Output: 即C2a,C2b中的Output2;

这个输出就代表着0.1BTC的HTLC的完整逻辑；要花费它可以有两种方式，就是我们上面所定义的两种路径：

![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_htlc2-2.jpg)
...
![img](../../images/blog_brain-zhang_brain-zhang.github.io_source_20191126_bg1-1.png)
