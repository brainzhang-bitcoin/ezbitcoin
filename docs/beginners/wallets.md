...
[<img src="../images/beginners_wallets_electrum-screenshot.png" alt="Screenshot of the Electrum wallet." width="777" height="426" />](/docs/beginners/wallets/electrum-screenshot.png.md)
...
[<img src="../images/diagrams_png_beginners-wallets-download.png" alt="Diagram showing a bitcoin wallet being downloaded directly from the wallet's website." width="503" height="378" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-download.png)
...
[<img src="../images/diagrams_png_beginners-wallets-seed.png" alt="Diagram showing a seed being written down on paper." width="601" height="371" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-seed.png)
...
[<img src="../images/diagrams_png_beginners-wallets-seed-addresses.png" alt="Diagram showing a seed as the source of all the private keys and addresses in a wallet." width="578" height="423" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-seed-addresses.png)
...
[<img src="../images/diagrams_png_beginners-wallets-receive.png" alt="Diagram showing the addresses in a wallet as being used for receiving bitcoin payments." width="608" height="257" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-receive.png)
...
[<img src="../images/diagrams_png_beginners-wallets-send.png" alt="Diagram showing a wallet creating a transaction and sending it into the network when you make a payment." width="771" height="325" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-send.png)
...
[<img src="../images/diagrams_png_beginners-wallets-software-wallet.png" alt="Diagram showing a software wallet on a computer with a direct connection to the Internet." width="435" height="318" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-software-wallet.png)
...
[<img src="../images/diagrams_png_beginners-wallets-node-vs-wallet-trust.png" alt="Diagram showing a software wallet sending information to a Bitcoin Core node." width="983" height="654" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-node-vs-wallet-trust.png)
...
[<img src="../images/diagrams_png_beginners-wallets-exchange-vs-wallet.png" alt="Diagram highlighting the difference between holding bitcoins in an exchange vs your own wallet." width="624" height="529" />](https://static.learnmeabitcoin.com/diagrams/png/beginners-wallets-exchange-vs-wallet.png)
